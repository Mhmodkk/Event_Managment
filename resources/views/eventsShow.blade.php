    <x-main-layout>
                                        ...
                                        <div class="flex items-start justify-between gap-5">
                                            <div class="flex items-center gap-4 rtl:flex-row-reverse">
                                                <div
                                                    ...
                                                    <svg class="w-7 h-7 text-[#355872] dark:text-[#222831]"
                                            ...
                                            @can('view', $comment)
                                                <form
                                                    ...
                                                    @csrf @method('DELETE')
                                                    <button type="submit"
                                                        class="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 font-medium text-sm">حذف</button>
                                                </form>
                                            @endcan
                                        </div>
                                    </div>
                ...
                <div class="space-y-8 lg:space-y-10">
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-5">
                            <svg class="w-8 h-8 text-[#7AAACE] flex-shrink-0 mt-1" fill="none"
                    ...
                    @auth
                        @if ($attending && $qrCodeUrl)
                            <div
                                ...
                                <h3 class="text-2xl font-bold text-[#355872] dark:text-[#DFD0B8] mb-6">رمز الحضور الخاص بك
                                </h3>
                                <div
                                ...
                                <p class="mt-6 text-[#948979] dark:text-[#948979] text-base">امسح هذا الكود عند الوصول
                                    لتسجيل حضورك</p>
                            </div>
                        @elseif (!$attending)
                            <div
                                class="bg-[#9CD5FF] dark:bg-[#948979] p-8 rounded-3xl text-center border border-[#7AAACE] dark:border-[#DFD0B8]">
                                <p class="text-lg font-medium text-[#355872] dark:text-[#222831]">احجز مكانك أولاً ليظهر
                                    رمز QR الخاص بك</p>
                            </div>
                        @endif
                    @endauth
                    ...
                    @auth
                        @if (!auth()->user()->isAdmin() && !auth()->user()->isSuperAdmin() && $event->is_public && $event->num_tickets > 0)
                            <div
                                ...
                                <!-- باقي كود الحجز كما هو بدون تغيير -->
                                <form id="attending-form" class="space-y-6">
                                    @csrf
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-[#948979] dark:text-[#948979] mb-2">عدد
                                            التذاكر</label>
                                        ...
                                        <p class="text-sm text-[#948979] dark:text-[#948979] mt-2">متبقي: <span
                                    ...
                                    <button type="button" onclick="submitAttending()"
                                        class="w-full py-4 bg-[#7AAACE] hover:bg-[#9CD5FF] text-white font-bold rounded-2xl transition text-lg">حجز
        ...
        <div id="qrSuccessModal"
            ...
            <div
                class="bg-[#F7F8F0] dark:bg-[#393E46] p-8 rounded-2xl max-w-md w-full text-center relative shadow-2xl">
