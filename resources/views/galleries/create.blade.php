    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('galleries.store') }}" enctype="multipart/form-data"
                ...
                <div>
                    <label for="event_id"
                        class="block mb-2 text-sm font-medium text-[#948979] dark:text-[#948979]">الفعالية
                        المرتبطة</label>
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-[#948979] dark:text-[#948979]" for="image">رفع
                        الصورة</label>
                    <input
