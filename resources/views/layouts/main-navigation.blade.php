    <nav x-data="{ open: false }" class="bg-[#F7F8F0] dark:bg-[#222831] border-b border-[#9CD5FF] dark:border-[#948979]"
            ...
            <div class="flex justify-between h-20">
                <div class="flex">
                    ...
                    <div class="hidden space-x-reverse space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                        <x-nav-link :href="route('eventIndex')" :active="request()->routeIs('eventIndex') || request()->is('/')">
                            الكليات
                        </x-nav-link>
                        <x-nav-link :href="route('eventIndex')" :active="request()->is('events*')">
                            الفعاليات
                        </x-nav-link>
                        <x-nav-link :href="route('eventIndex', ['archive' => 1])">
                            الأرشيف
                        </x-nav-link>
                    </div>
                </div>
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('eventIndex')">الكليات</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('eventIndex')">الفعاليات</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('eventIndex', ['archive' => 1])">الأرشيف</x-responsive-nav-link>
