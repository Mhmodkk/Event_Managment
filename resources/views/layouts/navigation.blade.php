        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('storage/logos/hpu-logo.png') }}" alt="HPU Logo" class="h-9 w-auto object-contain">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-[var(--color-text-secondary)] bg-[var(--color-bg-card)] hover:text-[var(--color-text-primary)] focus:outline-none transition ease-in-out duration-150">
