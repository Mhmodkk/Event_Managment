<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-[#355872] dark:text-[#DFD0B8] leading-tight text-right">
            لوحة التحكم الخاصة بمدير المنصة
        </h2>
    </x-slot>
    ...
    <div class="py-12" dir="rtl">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- أزرار الإدارة السريعة (الروابط التي كنت تريدها) -->
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse ($allEvents as $event)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                                ...
                                <td class="px-6 py-4 text-center font-bold text-[#7AAACE]">
                                    {{ $event->attendings_count }}
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-[#948979]">
