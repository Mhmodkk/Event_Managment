<x-main-layout>
    <section class="bg-[#F7F8F0] dark:bg-[#222831] min-h-screen">
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                @foreach ($events as $event)
                    <div class="lg:flex bg-[#F7F8F0] dark:bg-[#393E46] rounded-md overflow-hidden">
                        ...
                        <div class="flex flex-col justify-between py-6 lg:mx-6 w-full">
                            ...
                            <span class="text-sm text-center text-white bg-[#7AAACE] rounded-md p-2 w-full block">
                                {{ $event->faculty->name }}
                            </span>
                            ...
                            <div class="flex flex-wrap gap-2 mt-2">
                                @foreach ($event->tags as $tag)
                                    <p
                                        class="text-sm p-1 bg-[#9CD5FF] dark:bg-[#948979] dark:text-[#222831] rounded-md">
                                        {{ $tag->name }}
                                    </p>
                                @endforeach
                            </div>
